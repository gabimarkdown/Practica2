...
grafico<-ggplot(ds, aes(x = Temp9am, y = Pressure9am,color=RainToday))+geom_point()
grafico

#le he incluido la forma del punto sobre la variable categorica y le añafo un titulo descriptivo
grafico_1<-ggplot(ds, aes(x = Temp9am, y = Pressure9am,shape=RainToday))+geom_point()+ggtitle("Grafico sobre dos variables(Temp9am y Pressure9am)de un conjunto de datos(ds)")
grafico_1
